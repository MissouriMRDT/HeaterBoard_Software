...
// overheat LEDs
#define HEATER_1_OVERHEAT_LED   23
#define HEATER_2_OVERHEAT_LED   22
#define HEATER_3_OVERHEAT_LED   9
#define HEATER_4_OVERHEAT_LED   8
#define HEATER_5_OVERHEAT_LED   7
#define HEATER_6_OVERHEAT_LED   6
#define HEATER_7_OVERHEAT_LED   5
#define HEATER_8_OVERHEAT_LED   4
#define HEATER_9_OVERHEAT_LED   3
#define HEATER_10_OVERHEAT_LED  2
#define HEATER_11_OVERHEAT_LED  1
...
const uint8_t maxHeatersEnabled = 6;
